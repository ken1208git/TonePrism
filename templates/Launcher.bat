@echo off
REM Launcher.bat - launches TonePrism Launcher from the install parent folder.
REM Deployed by Install.bat to <parent>/Launcher.bat (one level above TonePrism/).
...
start "" "%~dp0TonePrism\Launcher\TonePrism_Launcher.exe"
exit
