...
#### マイルストーン0.1: Godotプロジェクトセットアップ完了（v0.1.0）

- **バージョン**: v0.1.0（開発版・アルファ版）
- **対応フェーズ**: フェーズ1の初期段階
- **目標期間**: 1週間
- **主要機能**:
  - Godotプロジェクトのセットアップ
...
#### マイルストーン0.2: 管理ソフト基本機能完成（v0.2.0）

- **バージョン**: v0.2.0（開発版・アルファ版）
...
- **技術的達成項目**:
  ...
  - データベースへの保存処理
- **重要性**:
  - このマイルストーンで作成したテストデータを、v0.4.0（データベース連携）以降で使用する
  - 管理ソフトがないと、以降の開発でテストデータを手動で作成する必要があり非効率

#### マイルストーン0.3: 基本画面・画面遷移（v0.3.0）

- **バージョン**: v0.3.0（開発版・アルファ版）
- **対応フェーズ**: フェーズ1の初期段階
- **目標期間**: 1-2週間
- **主要機能**:
...
#### マイルストーン0.4: データベース連携（v0.4.0）

- **バージョン**: v0.4.0（開発版・アルファ版）
- **対応フェーズ**: フェーズ1の中間段階
- **目標期間**: 1-2週間
- **主要機能**:
...
#### マイルストーン0.6: ゲーム起動機能（v0.6.0）

- **バージョン**: v0.5.0（開発版・ベータ版）
- **対応フェーズ**: フェーズ1の後期段階
- **目標期間**: 1-2週間
- **主要機能**:
  - ゲームの起動処理
...
#### マイルストーン0.7: UI完成・ゲーム情報詳細表示（v0.7.0）

- **バージョン**: v0.7.0（開発版・ベータ版）
- **対応フェーズ**: フェーズ1の最終段階
- **目標期間**: 1-2週間
- **主要機能**:
...
#### マイルストーン4: 管理ソフト完全版完成（v2.0.0）

- **バージョン**: v2.0.0（メジャーリリース、大きな機能追加）
- **対応フェーズ**: フェーズ4完了時点
- **目標期間**: 1-2ヶ月
- **主要機能**:
  - 管理ソフトの機能拡張（フェーズ1で実装した基本機能の拡張）
...
#### マイルストーン5: 完全版リリース（v2.1.0）

- **バージョン**: v2.1.0（機能追加・最適化）
- **対応フェーズ**: フェーズ5完了時点
