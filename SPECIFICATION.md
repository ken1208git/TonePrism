...
- LogSectionPanel の component selector は本規約に従い **tab 式 (3 tab: Launcher / Manager / Monitor)** で実装、Companion 用 tab は追加しない (= 3 component 収束方針の UI 表現)。
