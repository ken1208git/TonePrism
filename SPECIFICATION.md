...
- **Launcher 側 write 失敗** (SMB 一時不到達 / disk full 等): `Logger.warn` trail のみ、Launcher 起動 / ゲームプレイは止めない (= 部員視点で何も起きない、fail-soft 原則)
